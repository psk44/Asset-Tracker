...
class SoftwaresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create software" do
    assert_difference("Software.count") do
      post softwares_url, params: { software: { assigned_employees: @software.assigned_employees, license_count: @software.license_count, name: @software.name } }
    end
  ...
  test "should update software" do
    patch software_url(@software), params: { software: { assigned_employees: @software.assigned_employees, license_count: @software.license_count, name: @software.name } }
